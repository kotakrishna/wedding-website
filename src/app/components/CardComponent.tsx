...
<div className="container mt-32 mx-auto p-4 md:p-0">
  ...
  <div className="shadow-lg flex flex-wrap w-full lg:w-4/5 mx-auto">
    ...
    {/* <!-- Card image --> */}
    <div className="bg-cover bg-bottom border w-full md:w-1/3 h-64 md:h-auto relative" style={{backgroundImage:'url:(https://images7.alphacoders.com/347/347549.jpg'}}>
